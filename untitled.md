...
在 NumPy 中， `[..., None]` 表示使用一个 ellipsis（省略号）和 None 来扩展数组的维度。具体来说， `[..., None]` 表示在该维度上添加一个新的轴，这个轴的大小为 1，例如
...
但是如果\[..., None]的None换成了数字，则变成slice，如

```
// Some code
all_bboxes = array([[0.45625   , 0.31805557, 0.0390625 , 0.04444447],
                   [0.45546874, 0.31805557, 0.0390625 , 0.04444447]])
all_bboxes[..., 0]代表所有维度上的第一个元素，即[0.45625, 0.45546874]
all_bboxes[..., 1]代表所有维度上的第二个元素，即[0.31805557, 0.31805557]
```
